 ...
 * US175722_Prueba6
 *
 * o	PRUEBA 6 – Formato de precio no admitido.
 ...
 6.	El usuario intenta introducir un carácter no numérico en el campo del precio máximo.
 7.	La aplicación no permite introducir en el campo del precio máximo caracteres alfabéticos.

 */

public class IntegrationTest_US175722_Prueba6 {
    //No implementado
    ...
    public void integrationTest(){
        ...
        onView(withId(R.id.editText_maximo)).perform(typeText("**"));
